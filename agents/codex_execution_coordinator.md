...
涉及中国民商事诉讼、民事执行、公司责任、股东责任、人格否认、债权人撤销权、执行异议、银行流水、证据审查、法律检索等业务逻辑时：

1. Codex 只能根据明确任务书落地文件；
2. Codex 不得自行扩展法律结论；
3. Codex 不得自行编造裁判规则；
4. Codex 不得自行补充法律依据；
5. Codex 不得将未经确认的诉讼策略写成确定方案；
...
本项目面向中国民商事争议解决和民事执行场景。

涉及以下模块时，Codex 必须严格遵守任务书，不得自行扩展：
...
9. 履行能力分析；
10. 微信聊天记录证据审查；
11. 对账单、送货单、发票、付款记录分析；
12. 北大法宝法律检索 MCP；
13. 类案检索和裁判规则归纳；
14. 调查令申请；
15. 起诉状、执行文书、专项法律分析报告。
